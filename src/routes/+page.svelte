<script lang='ts'>
    ...
    import logoPhantom from "../lib/images/phantom.png";
                ...
                <div class="card-body px-6 pb-4 w-full mx-auto justify-center">
                    ...
                    <div class="flex flex-col pt-4 space-y-3 w-full mx-auto justify-center items-center">
                        ...
                        <p class="text-center text-sm text-[var(--background-color)] mt-2">
                            ...
                            <svg class="inline pl-1 h-8 pb-1" viewBox="0 0 24 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="https://phantom.app/download" target="_blank" rel="noopener noreferrer" class="md:inline flex items-center text-blue-600 underline">
                                <span class="pl-1">
                                    Créez-le maintenant sur Phantom !
                                </span>
                                <img class="inline w-7 pl-1 pb-1" alt="phantom logo" src={logoPhantom} />
                            </a>
                        </p>
                    </div>
